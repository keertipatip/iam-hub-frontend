...
const STATIC_POSTS: Post[] = [
  {
    ...
    Time: '2025-02-26 // 14:32 UTC // 8 MIN READ',
    TagClass: 'tc-article',
    TagLabel: 'ARTICLE',
  ...
  },
  {
    ...
    Time: '2025-02-26 // 09:14 UTC // OPEN SOURCE',
  ...
  },
  {
    ...
    Time: '2025-02-25 // 18:55 UTC // OPEN',
  ...
  return (
    <div className="post-card" style={delay ? { animationDelay: delay } : undefined}>
      ...
      <div className="post-foot">
        ...
        <button className="p-action" onClick={() => toast('LINK_COPIED')}>↗ SHARE</button>
